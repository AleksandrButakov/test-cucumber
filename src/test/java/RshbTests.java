...
public class RshbTests extends TestBase {
    ...
    @Test
    @DisplayName("01 Credit calculation test")
    ...
    @Test
    @DisplayName("02 Checking the link to farmers")
    ...
    @Test
    @DisplayName("03 Checking the link to small business")
    ...
    @Test
    @DisplayName("04 Checking a false link number one")
